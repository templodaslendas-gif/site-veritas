...
// width/height explícitos são obrigatórios: sem eles, SVGs sem tamanho
// intrínseco dentro de um container flex podem colapsar a 0px no Safari
// mobile (o navegador não infere o tamanho apenas do viewBox nesse contexto).
const ICON_PROPS = {
  viewBox: '0 0 24 24',
  width: 22,
  height: 22,
