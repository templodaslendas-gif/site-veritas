  ...
  return (
    ...
    >
      <div style={CONTAINER}>
        ...
        <SectionHeading
          eyebrow="Benefícios"
          title="Tudo o que sua obra ganha com Steel Frame."
          description="Cada vantagem do sistema industrializado se traduz em economia, conforto e tranquilidade — da fundação à entrega das chaves."
          maxWidth="640px"
        />
